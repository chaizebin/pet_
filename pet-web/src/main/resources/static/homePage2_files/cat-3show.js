...
function changeClass(pid){
    ...
    $("#li"+pid).removeClass("item")

}
function initTypeTwo(pid){
    $("#li"+pid).addClass("item")
    $.ajax({
...
function initType(pid){
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            var html="";
            for(var i=0;i<data.length;i++){
                /!*html+='<li style="height:50px;line-height: 50px;" class="item" id="li'+data[i].id+'" onmouseout="initTypeTwo('+data[i].id+')" onmouseout="changeClass('+data[i].id+')">' +
                    '<a href="#" class="visited" target="_blank">'+'<i class="dog1">'+'</i>'+'<span>'+data[i].text+'</span>'+'<b>'+'</b>'+'</a>'+
                    ...
                    '</div>'+
                    '</li>';*!/
                    html+='<li class="item" style="height:50px;line-height: 50px;" id="li'+data[i].id+'" onmouseover="initTypeTwo('+data[i].id+')" onmouseout="changeClass('+data[i].id+')">'+
                    '<a href="#" class="visited" target="_blank">'+
                    '<i class="dog1">'+'</i>'+
                    '<span>'+data[i].text+'</span>'
                    '<b>'+'</b>'+
                    '</a>'+
                    '<div style="display: none;" class="dorpdown-layer1 index_menus_sub">'+
                    '<div class="item-sub clear">'+
                    '<div class="subitems fl" id="first'+data[i].id+'">'+
                    '<dl class="fore1">'+
                    '<dt>'
                    '<a target="_blank" href="http://www.cz10000.com/List/10">'+data[i].text+'</a>'+
                    '</dt>'+
                    '<dd class="clear">'+
                    '<a target="_blank" href="http://www.cz10000.com/List/32">'+data[i].text+'</a>'+
                    '</dd>'+'</dl>'+'</div>'+
                '</div>'+
                '</div>'+
                '</li>';
