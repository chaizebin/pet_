...
function initCatList(page) {
    pageCount = page;
    $.ajax({
        url: 'http://127.0.0.1:8010/pet/queryOrderForPage',
        type:"POST",
        data:{
            page:page,
            rows:rows
        ...
        success: function (result) {
            ...
            $.each(data, function (index, row) {
                html += "<li class=\"shop-list\">" +
                    ...
                    "<span class=\"xl\">销量:"+row.sales+"&nbsp;&nbsp;</span>" +
                    "<div class=\"sub_title\">" +
                    "<a href=\"http://www.cz10000.com/Shop/6900\">"+row.othertype+"</a></div>" +
                    "<div class=\"sub_adress\"><span class=\"sub_adress_price\">" +
                    /*"<a href=\"http://www.cz10000.com/Store/index/id/8800\">多格漫宠物食品旗舰店</a>" +*/
                    "</span><span class=\"sub_adress_dz\">"+row.point+"</span></div></li>";
            })
            $('#catList').html(html);
